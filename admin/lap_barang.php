...
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'Go Kustom',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0038XXXXXXX',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. Kebon Jeruk',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'website : www.go-kios.com email : gokios@gmail.com',0,'L');
